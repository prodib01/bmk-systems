...
const Products = () => {
    ...
    const productCategories = [
        ...
        },
        {
            ...
            icon: <FaGraduationCap className="display-4 text-primary mb-3" />,
            description: 'Specialized training programs to enhance technical skills and capabilities of your team in various IT domains.',
            features: [
                'ODK (Open Data Kit) training',
                'REDCap data management training',
